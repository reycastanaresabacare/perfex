                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <?php foreach($client_contacts_fields as $field){
                                            ...
                                            ?>
                                            <?php $total_fields++; ?>
                                            <th class="bold"><?php if($field == 'firstname' || $field =='lastname' || $field == 'email'){echo '<span class="text-danger">*</span>';} ?> <?php echo str_replace('_',' ',ucfirst($field)); ?> <span class="text-info"><?php echo _l('import_contact_field'); ?></span></th>
                                            <?php } ?>
                                            <?php foreach($client_db_fields as $field){
                                                if(in_array($field,$not_importable)){continue;}
                                                ?>
                                                <?php $total_fields++; ?>
                                                <th class="bold"><?php if($field =='company'){echo '<span class="text-danger">*</span>';} ?> <?php echo str_replace('_',' ',ucfirst($field)); ?></th>
                                                <?php } ?>
